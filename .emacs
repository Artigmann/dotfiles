...
(set-face-attribute 'font-lock-function-name-face nil :foreground "DarkSeaGreen")
(set-face-attribute 'font-lock-keyword-face nil :foreground "DarkGoldenrod3")
(set-face-attribute 'font-lock-keyword-face nil :weight 'bold)
(set-face-attribute 'font-lock-string-face nil :foreground "green yellow")
(set-face-attribute 'font-lock-type-face nil :foreground "DarkSeaGreen")
;(set-face-attribute 'font-lock-type-face nil :foreground "sandy brown")
(set-face-attribute 'font-lock-variable-name-face nil :foreground "DarkSeaGreen")
