...
(show-paren-mode t)
  ...
  (define-key java-mode-map "\es" 'casey-save-buffer)

  (define-key java-mode-map "\t" 'dabbrev-expand)
  (define-key java-mode-map [S-tab] 'indent-for-tab-command)
  (define-key java-mode-map "\C-y" 'indent-for-tab-command)
  (define-key java-mode-map [C-tab] 'indent-region)
  (define-key java-mode-map "	" 'indent-region)

  (define-key java-mode-map "\ej" 'imenu)

  (define-key java-mode-map "\e." 'c-fill-paragraph)

  (define-key java-mode-map "\e/" 'c-mark-function)

  (define-key java-mode-map "\e " 'set-mark-command)
  (define-key java-mode-map "\eq" 'append-as-kill)
  (define-key java-mode-map "\ea" 'yank)
  (define-key java-mode-map "\ez" 'kill-region)
  
    (define-key java-mode-map "\C-m" 'newline-and-indent)


  ;; Handles tab and autocomplete
